    ...
    public class OrderRepository(OrderDbContext context) : IOrder
    {
        public async Task<Response> CreateAsync(Order entity)
        {
            try
            {
                ...
                return order.Id > 0 ? new Response(true, "Order place successfully") : new Response(false, "Error occured while creating order record.");
            }
            catch (Exception ex)
            {
                ...
                return new Response(false, "Error occured while creating order record.");
            }
        }
